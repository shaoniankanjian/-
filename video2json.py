...
class RequestApi(object):
    def __init__(self, appid, secret_key, upload_file_path, base_dir=''):
        self.appid = appid
    ...
    def gene_request(self, apiname, data, files=None, headers=None):
        ...
        # print(type(result))
        JSON_FILE = os.path.join(self.base_dir,'1.json')
...
if __name__ == '__main__':
    api = RequestApi(appid="5c7c913f", secret_key="720590985438df0c701b9ab4e3e0e124", upload_file_path=r"2.wav")
    result = api.all_api_request()

    # print(eval(result['data']))
    # print(type(eval(result['data'])))
